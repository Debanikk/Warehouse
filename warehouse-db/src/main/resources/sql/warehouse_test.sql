--These records are stored in the database to test the warehouse Application
...
insert into user_auth (id , uuid , user_id , access_token , expires_at , login_at, logout_at) values(1024 , 'database_uuid' , 1025 , 'database_accesstoken' , '2021-03-13 21:07:02.07' , '2021-03-13 13:07:02.07' , null);
insert into user_auth (id , uuid , user_id , access_token , expires_at , login_at , logout_at) values(1025 , 'database_uuid1' , 1026 , 'database_accesstoken1' , '2021-03-13 21:07:02.07' , '2021-03-13 13:07:02.07' , null );
insert into user_auth (id , uuid , user_id , access_token , expires_at , login_at , logout_at) values(1026 , 'database_uuid2' , 1027 , 'database_accesstoken2' , '2021-03-13 21:07:02.07' , '2021-03-13 13:07:02.07' , null );
insert into user_auth (id , uuid , user_id , access_token , expires_at , login_at , logout_at) values(1027 , 'database_uuid3' , 1028 , 'database_accesstoken3' , '2021-03-13 21:07:02.07' , '2021-03-13 13:07:02.07' , '2021-03-13 15:07:02.07' );


--Insert values in PRODUCTS table
insert into PRODUCTS (id,uuid,product_name,date,user_id) values(1024,'database_question_uuid','database_question_content','2021-03-13 19:41:19.593',1026);


--Insert values in WAREHOUSE table
insert into answer(id,uuid,product_capacity,date,user_id,product_id) values (1024,'database_answer_uuid',500,'2021-03-13 19:41:19.593',1026,1024);
